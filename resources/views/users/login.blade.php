    ...
    <div class="login_box grid grid-cols-2 mx-auto">
            ...
            <div style="padding-top:40px;padding-left:30px;padding-right:40px">
                ...
                <div style="padding-top: 40px">
                    ...
                    <input type="text" placeholder="Enter your email" name="email" class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow" style="background-color:white;color:black;border-color:rgb(169, 169, 169)">
                </div>
                <div style="padding-top: 20px">
                    <h3 style="color:rgb(107, 106, 106)">Password</h3>
                    <input type="password" placeholder="Enter password here.." name="password_hash"class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 text-sm border border-slate-200 rounded-md px-3 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow" style="background-color:white;color:black;border-color:rgb(169, 169, 169)">
                </div>
