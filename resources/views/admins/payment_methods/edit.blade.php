...
<div class="w-full mb-4 flex items-center justify-between">
        <h1>Settings → Payment Methods → {{ $payment_method->name }} → Edit</h1>
    </div>
        ...
        <form method="post" action="{{ route('payment_methods.update', $payment_method->id) }}">
            ...
            <div class="grid grid-cols-10 gap-4">
                <div class="col-span-4">
                    ...
                    <input class="mt-2 w-full" type="text" name="name" placeholder="Input name here..." value="{{ $payment_method->name }}"><br>
