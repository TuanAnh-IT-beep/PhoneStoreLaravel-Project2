...
@section('pageTitle', 'Payment Methods - Edit {{ $paymentMethod->name }}')
        ...
        <form method="post" action="{{ route('payment_methods.update', $paymentMethod->id) }}">
            ...
            <div class="grid grid-cols-10 gap-4">
                <div class="col-span-4">
                    ...
                    <input class="mt-2 w-full" type="text" name="name" placeholder="Input name here..." value="{{ $paymentMethod->name }}"><br>
