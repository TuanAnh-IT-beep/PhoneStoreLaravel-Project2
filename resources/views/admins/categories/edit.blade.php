        ...
        <form method="post" action="{{ route('categories.update', $category->id) }}" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-10 gap-4">
                ...
                <div class="col-span-6">
                    ...
                    <textarea class="mt-2 w-full" name="description" placeholder="Input description here..." rows="10">{{ $category->description }}</textarea><br>
                    <div class="flex items-center justify-between mt-2">
                        ...
                        <div>
                            ...
                            <input class="my-3 mx-3" type="checkbox" name="featured"
                                {{ $category->featured ? 'checked' : '' }}><br>
                        </div>
                    </div>
                    <div class="flex justify-center">
                        <img id="icon_preview" src="{{ $category->icon ? asset('storage/' . $category->icon) : '#' }}"
                            class="w-64 h-64 object-cover border rounded mb-3 {{ $category->icon ? '' : 'hidden' }}"
