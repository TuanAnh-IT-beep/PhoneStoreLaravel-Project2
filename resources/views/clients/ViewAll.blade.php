                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 items-stretch">
                    ...
                    <div class="w-full min-h-[350px] rounded-xl p-4 flex flex-col shadow-sm" style="background-color: #fafafadc">
                            ...
                            <img class="rounded-xl w-full h-48 object-cover flex-shrink-0" 
                                 src="{{ asset('storage/' . $search->thumbnail_path) }}"
                            ...
                            <div class="pt-4 flex-grow">
                                ...
                                <p style="color:gray;font-size:0.900rem">{{ $search->product->category->name }}</p>
                            ...
                            <div class="mt-auto pt-4">
                                <a href="/{{$search->product->id}}/{{ $search->id }}/details">
                                <button class="w-full bg-black text-white text-[10px] font-bold px-4 py-2 rounded-md uppercase tracking-wider hover:bg-gray-800 transition-colors">
                                    SHOP NOW
                                </button>
                            </a>
                            </div>
                    ...
                    @foreach ($product_byID->subproducts as $sub )
                        <div class="w-full min-h-[350px] rounded-xl p-4 flex flex-col shadow-sm" style="background-color: #fafafadc">
                            ...
                            <img class="rounded-xl w-full h-48 object-cover flex-shrink-0" 
                                 src="{{ asset('storage/' . $sub->thumbnail_path) }}"
                    ...
                    @foreach ($subproducts as $subproduct)
                        <div class="w-full min-h-[350px] rounded-xl p-4 flex flex-col shadow-sm" style="background-color: #fafafadc">
                            ...
                            <div class="mt-auto pt-4">
                                <a href="/{{$subproduct->product->id}}/{{ $sub->id }}/details">
                                <button class="w-full bg-black text-white text-[10px] font-bold px-4 py-2 rounded-md uppercase tracking-wider hover:bg-gray-800 transition-colors">
                                    SHOP NOW
                                </button>
                            </a>
