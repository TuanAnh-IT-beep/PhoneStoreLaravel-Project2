...
<div class="max-w-7xl mx-auto p-4 md:p-8 bg-white font-sans text-gray-900">
    <div class="grid grid-cols-12 gap-10">
        <div class="col-span-7">
            <div class="sticky top-4">
                <div class="relative rounded-3xl overflow-hidden bg-gray-100 aspect-square flex items-center justify-center border">
        ...
        <div class="col-span-5 space-y-6">
            ...
            <div>
                <label class="font-bold text-lg block mb-3">Phiên bản</label>
                    ...
                    @foreach ($subproducts as $subs)
                        <a href="/{{ $subs->product->id }}/{{ $subs->id }}/details"
                            ...
                            <div class="w-16 h-16 flex-shrink-0">
                                <img src="{{ asset('storage/' . $subs->thumbnail_path) }}" class="w-full h-full object-cover rounded-lg border">
                            </div>
                            <div class="flex-1">
                                <div class="font-bold text-gray-800">{{ $subs->name }}</div>
                                <div class="text-red-600 font-semibold">{{ number_format($subs->price, 0, ',', '.') }}đ</div>
                            </div>
                        </a>
                    @endforeach
                </div>
    ...
    <div class="my-12 border-t border-gray-100"></div>

    <div class="grid  grid-cols-12 gap-10">
        <div class="col-span-7">
            <h3 class="text-2xl font-bold mb-6">Mô tả sản phẩm</h3>
            <div class="prose max-w-none text-gray-700">
                <!-- Nội dung mô tả từ database -->
                {{ $subproduct->description ?? 'Đang cập nhật nội dung mô tả...' }}
            </div>
        </div>

        <div class="col-span-5">
            <h3 class="text-2xl font-bold mb-6">Thông số kỹ thuật</h3>
